...
recom_plot = ggsurvplot(recom_fit, data = recom, pval = TRUE, surv.median.line = "hv", conf.int = TRUE)

regular_fit = survfit(Surv(time_end, mode) ~ 1, data=regular)
regular_plot = ggsurvplot(regular_fit, data = regular, pval = TRUE, surv.median.line = "hv", conf.int = TRUE)

second_fit = survfit(Surv(time_end, mode) ~ 1, data=second)
second_plot = ggsurvplot(second_fit, data = second, pval = TRUE, surv.median.line = "hv", conf.int = TRUE)
```
```{r}
grid.arrange(regular_plot,second_plot,recom_plot,ncol=3)
```
